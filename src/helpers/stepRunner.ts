...
/** Run journey steps independently — a failed step is recorded and the next step still runs. */
export class StepRunner {
  ...
  assertAllPassed(): void {
    ...
    throw new Error(`${this.failures.length} step(s) failed (remaining steps were still executed):\n\n${summary}`);
  }
}
